 ...
 Log_Handle *r_log;
  ...
  for (size_t i = 0; i < SHA256_DIGEST_LENGTH_BYTES; i++)
   ...
   if (index == SHA256_DIGEST_LENGTH_BYTES)
    {
       printf("%s\n", "the_digest check of the first entry passed successfully!" );	/* code */
    } 
  ...
  for (size_t i = 0; i < SHA256_DIGEST_LENGTH_BYTES; i++)
   ...
   if (index == SHA256_DIGEST_LENGTH_BYTES)
    {
       printf("%s\n", "the_entry check of the first entry passed successfully!" );	/* code */
    }
  ...
  for (size_t i = 0; i < SHA256_DIGEST_LENGTH_BYTES; i++)
    ...
    if (index == SHA256_DIGEST_LENGTH_BYTES)
    {
       printf("%s\n", "the_digest check of the second entry passed successfully!" );	/* code */
    } 
   index=0;
   for (size_t i = 0; i < SHA256_DIGEST_LENGTH_BYTES; i++)
    {
   ...
   if (index == SHA256_DIGEST_LENGTH_BYTES)
    {
       printf("%s\n", "the_entry check of the second entry passed successfully!" );	/* code */
    }
